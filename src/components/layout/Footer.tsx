          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2 text-text-secondary">
                ...
                <a href="mailto:monkeymotionoficial@gmail.com" className="hover:text-white transition-colors">monkeymotionoficial@gmail.com</a>
              </li>
              <li className="flex items-start gap-2 text-text-secondary">
                <Clock className="w-4 h-4 text-accent-orange mt-0.5" />
                <span>L-V 10:00-20:00<br />S 11:00-15:00</span>
              </li>
            </ul>
            <div className="mt-5 flex gap-3">
              ...
              <a
                href="https://instagram.com/monkeymotion_oficial"
                target="_blank"
                rel="noopener noreferrer"
